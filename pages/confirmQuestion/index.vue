<template>
  <v-card class="elevation-1">
    <v-row>
      <h3 class="mt-7 mb-5 ml-5">ຢືນຢັນຄຳຖາມ >> ຄຳຖາມມາໃໝ່</h3>
    </v-row>
    <v-row class="my-5 mt-n11 d-flex justify-center">
      ...
      >
        <h2>ລາຍການຄຳຖາມມາໃໝ່</h2>
      </v-badge>
      <h2 v-else>ລາຍການຄຳຖາມມາໃໝ່</h2>
    </v-row>
    <v-divider></v-divider>
...
export default {
  data: () => ({
    ...
    newHeaders: [
      ...
      { text: 'ຜູ້ຕັ້ງຄຳຖາມ', value: 'customerName' },
      { text: 'ເບີ້ໂທ', value: 'customerPhone' },
      { text: 'ວັນທີ່ຕັ້ງຄຳຖາມ', value: 'sale_date' },
