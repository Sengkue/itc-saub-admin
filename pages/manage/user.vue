      ...
      <v-card class="px-5">
        <v-row>
          <v-col cols="12" sm="12" class="ml-3 mt-6 pa-0">
              <h4>ຈັດການຂໍ້ມູນພື້ນຖານ >> ຈັດການຂໍ້ມູນຜູ້ໃຊ້</h4>
          </v-col>
            ...
            <v-card>
              ...
              >
                ...
                <template #[`item.status`]="{ item }">
                  <div>
                    <div v-if="item.status === 1">user</div>
                    <div v-else>user</div>
                  </div>
                </template>
                ...
                <template #[`item.actions`]="{ item }">
                  <div class="d-flex">
                    <manage-user-delete :task="item" />
                    <manage-user-edit :task="item" />
                    <manage-user-view :task="item" />
                  </div>
                </template>
              </v-data-table>
            </v-card>
